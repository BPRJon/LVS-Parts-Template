--ORIGINAL TEMPLATE BY LUNA, MODIFIED BY JON B TO WORK WITH GREBBIN SYSTEM
--ORIGINAL TEMPLATE BY LUNA, MODIFIED BY JON B TO WORK WITH GREBBIN SYSTEM
--ORIGINAL TEMPLATE BY LUNA, MODIFIED BY JON B TO WORK WITH GREBBIN SYSTEM

ENT.Base = "lvs_base_fighterplane"

ENT.PrintName = "modifed template script" --spawnmenu name
ENT.Author = "*your name*"
ENT.Information = "Modified template script for the unofficial parts system"
...
ENT.RightWingModel = ""
ENT.TailModel = ""
ENT.LeftAileronModel = ""
ENT.RightAileronModel = ""
ENT.ElevatorModel = ""
ENT.RudderModel = ""
ENT.PropellerModel = "" -- Set to nil if not using a propeller
--Every part above is required except propeller. These are not automatically added to GibModels.
